...
// The AdmNumberQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type AdmNumberQueryRuleFunc func(context.Context, *ent.AdmNumberQuery) error

// EvalQuery return f(ctx, q).
func (f AdmNumberQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AdmNumberQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.AdmNumberQuery", q)
}

// The AdmNumberMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type AdmNumberMutationRuleFunc func(context.Context, *ent.AdmNumberMutation) error

// EvalMutation calls f(ctx, m).
func (f AdmNumberMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.AdmNumberMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.AdmNumberMutation", m)
}
